...
@section('page_breadcrumb', 'Laporan Stok Produk')
...
@section('content')
    ...
    <div class="flex items-center justify-between mb-[20px] flex-wrap gap-[12px]">
        ...
        <div class="flex items-center gap-[12px]">
            ...
            <button onclick="printReport()"
                ...
                Cetak Laporan Stock Produk
            </button>

            <a href="/admin/report-stock-history/export"
        ...
        <div class="bg-neutral-50 rounded-[20px] p-[18px] shadow-[0_2px_16px_rgba(0,0,0,0.07)] mb-[24px]">
            ...
            <div class="flex items-center justify-between flex-wrap gap-[18px]">
                ...
                <div class="flex items-center gap-[12px] flex-wrap">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option
                                value="Online"
                                {{ request('location') == 'Online' ? 'selected' : '' }}>
                                Online
                            </option>

                            <option
                                value="Bazar"
                                {{ request('location') == 'Bazar' ? 'selected' : '' }}>
                                Bazar
                            </option>
                ...
                <div class="flex items-center gap-[10px]">
                    ...
                    <a
                        href="{{ route('report.stock-history') }}"
                        class="px-[20px] py-[11px] border border-neutral-300 rounded-xl font-bold text-[13px]">
    ...
    <div class="w-full overflow-x-auto touch-pan-x [&::-webkit-scrollbar]:h-[6px] [&::-webkit-scrollbar-thumb]:bg-neutral-300 [&::-webkit-scrollbar-thumb]:rounded-full">
        ...
        <table class="w-full border-collapse bg-neutral-50 rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(0,0,0,0.07)] min-w-[1400px]">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-[16px] py-[14px] border-t border-neutral-200 whitespace-nowrap">
                    ...
                    <td class="px-[16px] py-[14px] border-t border-neutral-200">
                        ...
                        @else
                            ...
                            <span class="px-[10px] py-[4px] rounded-full text-[10px] font-bold bg-violet-100 text-violet-600">
                                Bazar
                            </span>
                    ...
                    <td class="px-[16px] py-[14px] border-t border-neutral-200 font-bold">
                ...
                <tr>
                    ...
                    <td colspan="8"
                        class="px-[16px] py-[30px] text-center text-neutral-400 border-t border-neutral-200">
