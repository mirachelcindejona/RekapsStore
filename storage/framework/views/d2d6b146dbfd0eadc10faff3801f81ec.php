...
<div class="flex items-center bg-neutral-50 rounded-xl pl-3 pr-10 py-3 gap-3">
    ...
    <div class="flex-1 min-w-0">
        ...
        <p class="text-xs text-neutral-400">Variasi: <?php echo e($product->variants->first()->variant_name ?? '-'); ?></p>
    </div>
    
    <div class="flex flex-col items-end gap-2 shrink-0">
        <p class="text-sm font-bold text-neutral-800">Rp<?php echo e(number_format($product->selling_price - ($product->selling_price * $product->discount / 100), 0, ',', '.')); ?></p>
