...
<aside id="sidebar"
    ...
    <nav
        ...
        <a href="<?php echo e(url('/admin')); ?>"
            class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
        ...
        <a href="<?php echo e(url('/admin/product')); ?>"
            class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/product*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
            <span class="w-[18px] shrink-0 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <a href="<?php echo e(url('/admin/orders')); ?>"
            class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/orders*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
            <span class="w-[18px] shrink-0 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <a href="<?php echo e(url('/admin/finance')); ?>"
            class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/finance*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
            <span class="w-[18px] shrink-0 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <a href="<?php echo e(url('/admin/promo')); ?>"
            class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/promo*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
            <span class="w-[18px] shrink-0 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <a href="<?php echo e(url('/admin/users')); ?>"
            class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/users*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
            <span class="w-[18px] shrink-0 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <span class="w-[18px] shrink-0 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                    ...
                    <path
                        ...
                        stroke="<?php echo e(request()->is('admin/reports*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </span>
            Laporan
...
<!-- END .sidebar -->
<?php /**PATH C:\Users\x395\OneDrive\Desktop\RekapsStoreFinal\RekapsStore\resources\views/components/admin/sidebar-admin.blade.php ENDPATH**/ ?>