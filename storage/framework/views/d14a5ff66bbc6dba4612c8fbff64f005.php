<nav class="flex flex-col shadow-md gap-2 px-2 sm:px-5 py-2 fixed bg-neutral-50 w-full box-border z-50">
    <div class="flex gap-2">
        ...
        <div class="flex flex-1 justify-end sm:justify-center items-center gap-1">
            <a href="#" class="w-[40px] h-[40px] flex justify-center items-center cartbox bg-neutral-200 rounded-lg sm:rounded-xl hover:bg-primary-500 cursor-pointer">
                <img class="cart cursor-pointer" src="<?php echo e(asset('assets/icons/cart-line.svg')); ?>" alt="">
            </a>
            <a href="#" class="w-[40px] h-[40px] flex justify-center items-center historybox block md:hidden bg-neutral-200 rounded-lg sm:rounded-xl hover:bg-primary-500 cursor-pointer">
                <img class="history cursor-pointer" src="<?php echo e(asset('assets/icons/history-home.svg')); ?>" alt="">
            </a>
            <a href="#" class="w-[40px] h-[40px] flex justify-center items-center accountbox block md:hidden bg-neutral-200 rounded-lg sm:rounded-xl cursor-pointer">
        ...
        <div class="flex-1 gap-2 justify-end items-center hidden sm:flex">
            <a href="/login" class="border-2 font-semibold text-primary-500 border-primary-500 pb-1 pt-1 px-5 rounded-xl transition duration-300 ease-in-out hover:bg-primary-100">Login</a>
            <a href="/register" class="border-2 font-semibold bg-primary-500 text-neutral-50 border-primary-500 pb-1 pt-1 px-5 rounded-xl transition duration-300 ease-in-out hover:bg-primary-600">Register</a>
        </div>
    </div>
...
</script><?php /**PATH C:\Users\x395\OneDrive\Desktop\WEEBSPROJECT\RekapsStore\resources\views/components/client/navbar-index.blade.php ENDPATH**/ ?>