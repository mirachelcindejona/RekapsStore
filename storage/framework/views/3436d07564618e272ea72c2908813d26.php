...
<?php $__env->startSection('page_breadcrumb', 'Pengguna'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-[24px] overflow-hidden shadow-sm border border-[#ece7f7]">
        <table class="w-full">
            ...
            <tbody id="pengurusTable">
                ...
                <?php $__currentLoopData = $pengurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-b border-[#f1edf8] hover:bg-[#faf8ff] transition-all duration-200">
                        ...
                        <td class="px-6 py-5">
                            ...
                            <?php echo e($role == 'admin' ? 'bg-[#efe4ff] text-primary-500' : 'bg-[#ffe4e6] text-[#f43f5e]'); ?>">
                        ...
                        <td class="px-6 py-5">
                            <p class="text-[13px] text-neutral-700">
                                <?php echo e($user->created_at ? $user->created_at->format('F Y') : '-'); ?>
                        ...
                        <td class="px-6 py-5">
                            <span
                                class="px-3 py-1 rounded-full text-[11px] font-bold
                            <?php echo e($user->status == 'active' ? 'bg-[#ecfccb] text-[#65a30d]' : 'bg-[#ffe4e6] text-[#f43f5e]'); ?>">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center justify-center gap-3">
                                <!-- EDIT -->
                                <button onclick="openEditModal(this)" data-id="<?php echo e($user->id); ?>"
                                    data-name="<?php echo e($user->name); ?>" data-email="<?php echo e($user->email); ?>"
                                    data-status="<?php echo e($user->status); ?>" data-permissions='<?php echo json_encode($user->getAllPermissions()->pluck('name'), 15, 512) ?>'
                                ...
                                <!-- DELETE -->
                                <button type="button" onclick="openDeleteModal('<?php echo e($user->id); ?>')"
                ...
                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-b border-[#f1edf8] hover:bg-[#faf8ff] transition-all duration-200">
                        ...
                        <td class="px-6 py-5 text-center">
                            <form id="toggleForm<?php echo e($user->id); ?>"
                                action="<?php echo e(route('admin.users.toggleStatus', ['user' => $user->id, 'tab' => 'pembeli'])); ?>"
                                method="POST">
                                ...
                                <?php if($user->status == 'active'): ?>
                                    <!-- ICON MATA -->
                                    <button type="button" onclick="openBlockModal(<?php echo e($user->id); ?>)"
                                ...
                                <?php else: ?>
                                    <!-- ICON BLOCK -->
                                    <button type="button" onclick="openUnblockModal(<?php echo e($user->id); ?>)"
                                ...
                                <div class="flex flex-col gap-[14px]">
                                    ...
                                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="flex items-center gap-[12px]">
                                            ...
                                            <span>
                                                <?php echo e(str_replace('manage-', '', $permission)); ?>
    ...
    <div id="userModal" class="hidden fixed inset-0 bg-black/40 flex items-center justify-center z-[9999] p-4">
        <div class="bg-white w-full max-w-[420px] rounded-[24px] p-7 shadow-xl">
            ...
            <form action="<?php echo e(route('admin.pengurus.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <button type="button" class="toggle-password absolute right-4 top-1/2 -translate-y-1/2">
                            <img src="<?php echo e(asset('assets/icons/eye-line.svg')); ?>" class="eye-icon h-5 w-5" alt="eye">
                        </button>
                    </div>
    ...
    <script>
        ...
        document.addEventListener(
            ...
            function() {
                ...
                const currentTab =
                    "<?php echo e(request('tab', 'pengurus')); ?>";
...
<?php echo $__env->make('admin.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\RekapsStore\resources\views/admin/users.blade.php ENDPATH**/ ?>