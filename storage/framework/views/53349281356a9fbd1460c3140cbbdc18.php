...
<header
    ...
    <div class="flex-1 flex flex-col gap-[1px]">
        <div class="text-[18px] font-bold text-neutral-950 leading-none"><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></div>
        <div class="text-[12px] text-neutral-400 font-medium">
            Rekaps Store / <span class="text-primary-500"><?php echo $__env->yieldContent('page_breadcrumb', 'Overview'); ?></span>
        </div>
    </div>
    ...
    <div class="flex items-center gap-[8px]">
        <div
            ...
            <img src="<?php echo e(asset('assets/icons/search-line.svg')); ?>" alt="Search" class="text-neutral-400 shrink-0" />
        ...
        <button
            ...
            <img src="<?php echo e(asset('assets/icons/bell-line.svg')); ?>" alt="Notification" />
        </button>
...
<!-- END .navbar -->
<?php /**PATH C:\Users\x395\OneDrive\Desktop\RekapsStoreFinal\RekapsStore\resources\views/components/admin/navbar-admin.blade.php ENDPATH**/ ?>