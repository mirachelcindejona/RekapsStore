...
<nav class="shadow-md px-2 sm:px-5 py-2 fixed bg-neutral-50 w-full box-border z-50">
    ...
    <?php if($variant === 'page'): ?>
        ...
        <div class="flex sm:hidden items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-3">
                ...
                <h1 class="font-semibold text-sm text-neutral-700"> <?php echo e($title); ?> </h1>
            </div>
    ...
    <div class="<?php echo e($variant === 'page' ? 'hidden sm:flex' : 'flex'); ?> gap-2">
        ...
        <div class="flex flex-1 justify-end items-center gap-1.5">
            ...
            <a href="#" class="cartbox w-[40px] h-[40px] flex items-center justify-center bg-neutral-200 rounded-lg hover:bg-primary-500 transition-all duration-300 ease-in-out cursor-pointer">
...
</script><?php /**PATH C:\Users\x395\OneDrive\Desktop\rekapsstorefinal\RekapsStore\resources\views/components/client/navbar-main.blade.php ENDPATH**/ ?>