<nav class="flex flex-col shadow-md gap-2 px-2 sm:px-5 py-2 fixed bg-neutral-50 w-full box-border z-50">
    <div class="flex gap-2">
        ...
        <div class="hidden flex-2 md:flex">
            <img src="<?php echo e(asset('assets/icons/logo-rekaps-text.svg')); ?>" width="200px" alt="">
        </div>
...
</script><?php /**PATH C:\Users\x395\OneDrive\Desktop\WEEBS\RekapsStore\resources\views/components/client/navbar-index.blade.php ENDPATH**/ ?>