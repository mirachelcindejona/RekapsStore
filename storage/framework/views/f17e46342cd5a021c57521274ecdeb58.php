...
<aside id="sidebar"
    ...
    <div class="px-[22px] pt-[24px] pb-[18px] border-b border-white/5 flex items-center justify-center shrink-0">
        <div class="rounded-xl flex items-center justify-center shrink-0 relative overflow-hidden mr-2">
            <img src="<?php echo e(asset('assets/icons/logo-rekaps.svg')); ?>" alt="Logo" class="relative z-10" />
        </div>
    ...
    <nav
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard')): ?>
            ...
            <?php echo e(request()->is('admin') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                ...
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <path
                            ...
                            stroke="<?php echo e(request()->is('admin') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('produk')): ?>
            <a href="<?php echo e(url('/admin/product')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px]
            transition-colors duration-[250ms] mb-[2px] outline-none
            <?php echo e(request()->is('admin/product*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                ...
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <path
                            ...
                            stroke="<?php echo e(request()->is('admin/product*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </span>
            ...
            <a href="<?php echo e(url('/admin/categories')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/categories*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.16669 4.16667H17.5M9.16669 10H17.5M9.16669 15.8333H17.5"
                            stroke="<?php echo e(request()->is('admin/categories*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pesanan')): ?>
            <a href="<?php echo e(url('/admin/orders')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px]
            transition-colors duration-[250ms] mb-[2px] outline-none
            <?php echo e(request()->is('admin/orders*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                ...
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <path
                            ...
                            stroke="<?php echo e(request()->is('admin/orders*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </span>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('keuangan')): ?>
            ...
            <a href="<?php echo e(url('/admin/finance')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px]
            transition-colors duration-[250ms] mb-[2px] outline-none
            <?php echo e(request()->is('admin/finance*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                ...
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <path
                            ...
                            stroke="<?php echo e(request()->is('admin/finance*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['diskon'])): ?>
            <a href="<?php echo e(url('/admin/promo')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px]
            transition-colors duration-[250ms] mb-[2px] outline-none
            <?php echo e(request()->is('admin/promo*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                ...
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <path
                            ...
                            stroke="<?php echo e(request()->is('admin/promo*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </span>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pengguna')): ?>
            ...
            <a href="<?php echo e(url('/admin/users')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px]
            transition-colors duration-[250ms] mb-[2px] outline-none
            <?php echo e(request()->is('admin/users*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                    ...
                    <path
                        ...
                        stroke="<?php echo e(request()->is('admin/users*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan')): ?>
            <a href="<?php echo e(url('/admin/reports')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/report*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="<?php echo e(request()->is('admin/report*') ? '#C6FF33' : '#D7C2F9'); ?>" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </span>
                Laporan
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kasir')): ?>
            <a href="<?php echo e(url('/admin/cashier')); ?>"
                class="flex items-center gap-[10px] p-[10px] rounded-lg text-[14px] transition-colors duration-[250ms] mb-[2px] outline-none <?php echo e(request()->is('admin/cashier*') ? 'bg-primary-500 text-neutral-50 shadow-[0_4px_14px_rgba(125,57,235,0.38)] font-bold' : 'text-[#d7c2f9] font-semibold hover:bg-primary-500/20 hover:text-neutral-50'); ?>">
                <span class="w-[18px] shrink-0 flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="p-[14px] border-t border-white/5 shrink-0">
        ...
        <form action="<?php echo e(route('admin.logout')); ?>" method="POST">
            ...
            <button type="submit"
                ...
                <img src="<?php echo e(asset('assets/icons/logout-half-circle-line.svg')); ?>" alt="Logout" />
...
<?php /**PATH C:\xampp\htdocs\rekapsapp-byweebs\resources\views/components/admin/sidebar-admin.blade.php ENDPATH**/ ?>