...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'page','title' => 'Pembayaran']); ?>
        ...
        <div class="flex flex-col md:flex-row gap-2">
            ...
            <div class="flex flex-col items-center bg-neutral-50 justify-center gap-4 p-4 lg:p-8 md:w-1/2 border-1 border-neutral-300 rounded-2xl">
                ...
                <div class="relative w-full h-fit object-contain">
                    <img src="<?php echo e(asset('assets/icons/qr-dummy.svg')); ?>" alt="QR Code" class="w-full h-full">
                </div>

                
                <div class="flex items-center gap-2 bg-primary-500 text-white px-6 py-2.5 rounded-xl w-full justify-center">
                    <img src="<?php echo e(asset('assets/icons/rekaps-store-logo-lw.svg')); ?>" alt="">
                </div>
            </div>
            ...
            <div class="flex flex-col md:w-1/2 gap-2">
                ...
                <div class="bg-neutral-900 rounded-2xl p-5 flex flex-col gap-3">
                    <div class="flex items-center justify-between">
                        ...
                        <p class="text-base font-extrabold text-secondary-400">Rp<?php echo e(number_format($total, 0, ',', '.')); ?></p>
                    </div>
                    <div class="flex items-center justify-between">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('components.client.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\x395\OneDrive\Desktop\WEEBS\RekapsStore\resources\views/payment.blade.php ENDPATH**/ ?>