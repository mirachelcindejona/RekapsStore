                ...
                <tbody>
                    ...
                    <tr class="hover:bg-primary-50 transition-colors duration-[250ms]">
                        <td
                            ...
                            <a href="<?php echo e(url('/admin/product-detail')); ?>" class="block">
                                <div class="flex items-center gap-[10px]">
                                    <img src="<?php echo e(asset('assets/img/products/jersey.png')); ?>"
...
<?php echo $__env->make('admin.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\RekapsStore\resources\views/admin/product.blade.php ENDPATH**/ ?>