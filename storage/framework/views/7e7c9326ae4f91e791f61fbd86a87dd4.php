...
<?php endif; ?>
<?php $component->withAttributes(['link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['link']),'discount' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['discount']),'image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['image']),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['name']),'price' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['price']),'rating' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['rating']),'reviews' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['reviews']),'category' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product['category'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
