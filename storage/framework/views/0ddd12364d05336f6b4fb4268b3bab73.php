...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-5">
    ...
    <div class="overflow-hidden rounded-3xl bg-white shadow-sm">
      <div class="flex items-start justify-between px-5 pt-5 mb-4">
        ...
        <a
          href="<?php echo e(url('/admin/reports')); ?>"
      ...
      <div class="px-5 pb-5">
        <div class="flex h-[155px] items-end gap-2">
          ...
          ?> <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$hari, $pendapatan, $pesanan]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="flex flex-1 flex-col items-center gap-2 h-full">
            <div class="flex flex-1 items-end gap-1 w-full">
              <div
                ...
                style="height: <?php echo e($pendapatan); ?>%; opacity: .9"
              ></div>

              <div
                class="w-full rounded-t-md bg-lime-400"
                style="height: <?php echo e($pesanan); ?>%"
              ></div>
            </div>
  ...
  <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
    ...
    <div class="flex items-start justify-between px-5 pt-5 mb-4">
      ...
      <a
        href="<?php echo e(url('/admin/orders')); ?>"
...
<?php echo $__env->make('admin.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rekapsapp-byweebs\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>