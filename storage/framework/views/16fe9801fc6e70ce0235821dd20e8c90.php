...
<a href="<?php echo e(url()->previous()); ?>" class="hidden sm:flex font-semibold text-neutral-500 gap-2 items-center pb-2 cursor-pointer mt-2 sm:mt-0">
...
<div class="flex flex-col sm:flex-row gap-2 mt-1 sm:mt-0">
    ...
    <div class="flex flex-row sm:flex-col flex-1 gap-2 h-full w-full">
        ...
        <div class="flex-5 flex flex-col gap-5">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-xl sm:text-2xl font-bold text-primary-500">
                    Rp<?php echo e(number_format(($product['price']-($product['price']*$product['discount']/100)), 0, ',', '.')); ?>
            ...
            <div class="flex items-center gap-2">
                ...
                <span>|</span>
                <span><?php echo e($product['reviews']); ?> Ulasan</span>
            </div>
            ...
            <div class="flex items-center gap-1 text-xs sm:text-sm font-semibold text-yellow-500 bg-yellow-100 rounded-full whitespace-nowrap px-3 py-1">
                <span class="leading-none"><?php echo e($product['category']); ?></span>
            </div>
...
<div class="flex flex-col gap-2 bg-neutral-50 rounded-xl mt-1">
    <div>
        ...
        <button id="detailToggle" class="w-full flex text-lg cursor-pointer gap-2 text-neutral-700 font-semibold items-center p-2">
            <img src="<?php echo e(asset('assets/icons/dropdown.svg')); ?>" alt="">
            Detail Produk  
        </button>
...
<div
    id="imageModal"
    class="fixed inset-0 bg-black/80 z-[999] hidden items-center justify-center p-4"
>
    ...
    <div class="relative max-w-5xl w-full">
        ...
        <button
            id="closeBtn"
            class="absolute -top-12 right-0 text-neutral-100 text-5xl cursor-pointer"
        >
            &times;
        </button>
        ...
        <img
            id="modalImage"
            src=""
            class="w-full max-h-[90vh] object-contain rounded-xl"
        >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('components.client.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\x395\OneDrive\Desktop\rekapsstorefinal\RekapsStore\resources\views/product-detail.blade.php ENDPATH**/ ?>