    ...
    <aside id="sidebar"
        ...
        <div class="flex flex-col items-center w-full">
            ...
            <div class="flex flex-col gap-[10px] w-full px-[14px]">
                <a href="<?php echo e(url('/pengurus/cashier')); ?>"
                ...
                <a href="<?php echo e(url('/pengurus/cashier-orders')); ?>"
                ...
                <a href="<?php echo e(url('/pengurus/cashier-recap')); ?>"
...
<?php /**PATH C:\xampp\htdocs\rekapsapp-byweebs\resources\views/pengurus/layouts/layout-cashier.blade.php ENDPATH**/ ?>