    ...
    public function run(): void
    {
        ...
        DB::table('notifications')->insert([
            [
                ...
                'product_id' => null,
                'title'      => 'Admin Rekaps',
                'message'    => 'Halo, Grace! Jangan lupa diambil ya pesanannya. Kami standby di tempat dari jam 10 pagi sampai jam 3 sore, setelah itu akan kami lanjut besok hari di tempat yang sama.',
                'type'       => 'info',
                'link'       => null,
                'is_read'    => false,
